...
const SupervisorCreateCoursePage = () => {
    const { t } = useLanguage();
    ...
    const handleCreateCourse = async () => {
        ...
        try {
            ...
            if (response.data?.id) {
                ...
                router.push(`/dashboard/supervisor/courses/${response.data.id}`);
            } else {
    ...
    const handleCancel = () => {
        router.push("/dashboard/supervisor/courses");
    };
...
export default SupervisorCreateCoursePage;
