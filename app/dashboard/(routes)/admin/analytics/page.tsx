    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <p className="text-sm text-muted-foreground">
          {t('admin.allCoursesAnalytics') || 'All Courses Analytics'}
        </p>
      </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b">
                ...
                <th className="text-left py-3 px-2">{t('dashboard.teacher') || 'Teacher'}</th>
            ...
            <tbody>
              {analytics.courseAnalytics.map((course) => (
                <tr key={course.id} className="border-b hover:bg-slate-50 transition">
                  ...
                  <td className="py-3 px-2">{course.teacherName}</td>
                  ...
                  <td className="text-center py-3 px-2">
                    <div className="flex items-center justify-center">
                      <div className="w-full bg-slate-200 rounded-full h-2.5 mr-2 max-w-[150px]">
                        <div
                          className="bg-[#090919] h-2.5 rounded-full"
